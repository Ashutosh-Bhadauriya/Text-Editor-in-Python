...
main_application.title(' AB Text Editor')
...
text_editor.configure(font = ('Arial', 12))            #    ****config and configure are same**** 

def change_font(event = None):        # here it is not necessary to pass main_application we can pass anything
...
def align_center():
    text_content = text_editor.get(1.0, 'end')
    text_editor.tag_config('centeralign_center', justify = tk.CENTER)
    text_editor.delete(1.0, tk.END)
    text_editor.insert(tk.INSERT, text_content, 'centeralign_center')
